...
interface RestActividad {
    ...
    suspend fun actualizarActividad(@Header("Authorizacion") token:String, @Path("id") id:Long, @Body actividad: Actividad): Response<Actividad>

    @POST("/asis/actividad/crear")
    suspend fun insertarActividad(@Header("Authorizacion") token:String, @Body actividad: Actividad): Response<Actividad>
